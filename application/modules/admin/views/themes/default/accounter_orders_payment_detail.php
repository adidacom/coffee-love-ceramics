                                ...
                                <?php if (count($payment_history)){ ?>
                                    <?php foreach ($payment_history as $key => $list): ?>
                                        <tr class="<?php if($key%2==0) echo 'odd'; else echo 'even'?>">
                                            ...
                                            <td><?php if($list->paid_type=='prepay') echo '预付'; else echo '尾付'?> </td>
                                            <td><?=$list->receiver_bank?></td>
                                            <td>
                                                <?php
...
<form id="order_payment_confirm_sattus_change_frm" method="POST"  action="<?=base_url('admin/orders_customer/regist_payment_history')?>" class="hidden">
