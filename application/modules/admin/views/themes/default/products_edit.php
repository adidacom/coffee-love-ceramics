            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <?php endif; ?>
                        <div class="">
                            <form role="form" method="POST" action="<?=base_url('admin/products/edit/'.$product->id)?>" id="products_mng_frm" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-12" style="background-color: #f5f5f5; padding-top:15px; margin-top:-15px;">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8">
                                                <select class="form-control" id="product_information_id1" name="product_information_id" readonly>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8">
                                                <input class="form-control" placeholder="" id="tiles_per_box_quantity" readonly name="tiles_per_box_quantity"  value="<?php echo $product->tiles_per_box_quantity?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-xs-4 control-label">色号</label>
                                            <div class="col-xs-8">
                                                <select class="form-control" id="color_id" name="color_id" readonly="">
                                                    <?php
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8">
                                                <input type="number" class="form-control" placeholder="输入箱" id="box_quantity" name="box_quantity"  readonly value="<?php echo $product->box_quantity?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8">
                                                <select class="form-control" id="store_id" name="store_id" readonly>
