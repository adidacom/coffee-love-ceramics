            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <?php endif; ?>
                        <div class="">
                            <form role="form" method="POST" action="<?=base_url('admin/product_loss/create')?>" id="products_loss_detail_mng_frm" class="form-horizontal" >
                                ...
                                <div class="col-sm-12" style="background-color: #f5f5f5; padding-top:15px; margin-top:-15px;">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8">
                                                <input type="number" class="form-control" placeholder="" id="tiles_per_box_quantity" name="tiles_per_box_quantity" readonly />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <textarea id="loss_description" name="loss_description" cols="50" role="20"></textarea>
                                        </div>
                                    </div>
                                </div>
