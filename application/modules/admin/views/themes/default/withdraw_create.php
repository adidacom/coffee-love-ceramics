            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <?php endif; ?>
                        <div class="col-lg-6">
                            <form role="form" method="POST" action="<?=base_url('admin/accounter/withdraw_list/create')?>" id="withdraw_mng_frm">
                                ...
                                <div class="form-group">
                                    <label>应付金额</label>
                                    <input class="form-control" placeholder="输入付款金额" id="withdraw_amount" name="withdraw_amount">
                                </div>
