...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "coffee_love_ceramics/assets/admin/images";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "coffee_love_ceramics/assets/admin/images";
        
$username = "admin@admin.com"; $password = '5f4dcc3b5aa765d61d8327deb882cf99';
